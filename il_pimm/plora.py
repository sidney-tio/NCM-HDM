# This code is adapted from https://github.com/yoyo-yun/PLoRA/blob/main/models/ppeft/plora.py
import math
import re
import warnings
...
class PLoraModel(torch.nn.Module):
    ...
    def add_adapter(self, adapter_name, config=None):
        if config is not None:
            config = self._prepare_lora_config(config, self.model.config)
...
class PLoRaWrapper(nn.Module):
    ...
    def forward(self, input_ids, attention_mask=None, user_ids=None, labels=None, **kwargs):
        p = self.model.get_embeddings(user_ids,input_ids,attention_mask)
        self.current_p = p
